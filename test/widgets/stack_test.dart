...
void main() {
  ...
  testWidgets('Can construct an empty Centered Stack', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
  ...
  testWidgets('Can construct an empty IndexedStack', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const Directionality(
  ...
  testWidgets('Can construct an empty Centered IndexedStack', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const Directionality(
  ...
  testWidgets('Can set and update clipBehavior', (WidgetTester tester) async {
    ...
    final RenderStack renderObject = tester.allRenderObjects
        .whereType<RenderStack>()
        .first;
  ...
  testWidgets('Clip.none is respected by describeApproximateClip', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const Stack(
  ...
  testWidgets('IndexedStack excludes focus for hidden children', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Positioned.directional control test', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('PositionedDirectional control test', (
    WidgetTester tester,
  ) async {
    final Key key = UniqueKey();
    await tester.pumpWidget(
  ...
  testWidgets('Can change the text direction of a Stack', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('IndexedStack does not assert when index is null', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const Directionality(
  ...
  testWidgets('IndexedStack asserts when index is negative', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const Directionality(
