...
void main() {
  ...
  testWidgets('FittedBox layers - cover - horizontal', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const Center(
  ...
  testWidgets('FittedBox layers - cover - vertical', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const Center(
  ...
  testWidgets('Big child into small fitted box - hit testing', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Can set and update clipBehavior', (WidgetTester tester) async {
    ...
    final RenderFittedBox renderObject = tester.allRenderObjects
        .whereType<RenderFittedBox>()
        .first;
  ...
  testWidgets('FittedBox without child does not throw', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const Center(
  ...
  testWidgets('FittedBox with zero size child does not throw', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const Center(
